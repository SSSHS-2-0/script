...
function prepareRoot {
  ...
  if [ -f root.hints ]; then
    ...
    dialog --backtitle "$BACKTITLE" --msgbox "root.hints file not found, please try to download by hand: wget -O root.hints https://www.internic.net/domain/named.root" 0 0
  fi
  #change owner shipp
