...
# Filename: config.sh
#
# Description: Harden sshd config
#========================================================

echo -en "\n"
${LOGGING} -i "Hardening sshd config (disable X11Forwarding, enable domainname lookup, disable root login, enabling only strong algorithms)"
